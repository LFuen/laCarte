...
class Ingredients extends Component {
  ...
  render() {
    ...
    if (meals.length > 0) {
      ...
      const ingr = meals.length
        ? meals.find((ing) => ing.id === Number(ingID))
        : "";
          ...
          <div className="page">
            ...
            <div className="group">
              ...
              <div className="chefs">
                <h2>Chefs</h2>
                <p className="listing">
                  Who would You like to prepare your meal?
                </p>
