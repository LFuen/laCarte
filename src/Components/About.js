    ...
    render() {
        return (
            <div>
                ...
                <p>Face it: you're a workaholic. Maybe not always consciously, but more often than not, you look up at the end of that
                ...
                <p>This is where <em>we</em> step in. No more fast, greasy, or generally unhealthy late-night entrees that conspire with your
                workaholic ways to cause that inevitable heart attack! We're not judging, just sayin'...</p>

                <p>Let our world-class and trained culinary chefs provide thoughtful and well-balanced meals for you so you can finally, 
                <em>finally</em> get rid of that "last thing" that's taking precedence right now!</p>

                <p>Currently, we're only able to offer our services to the greater D.C. area. Please check back periodically as we add new cities! </p>
            </div>
        )
    }
}
