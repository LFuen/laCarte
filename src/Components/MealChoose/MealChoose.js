        ...
        <div className="choices">
          <div className="option">
            ...
            {cuisines.map((cuisine) => {
              return (
                <Link
                  to={`/cuisines/${cuisine.id}/${cuisine.origin}`}
                  key={cuisine.id}
                >
          ...
          <div className="option">
            <span title="Dinner is Served!">
              <img
                className="mainImage"
                alt="served"
                src="https://lfuen.github.io/laCarte/images/served.png"
              />
            </span>
            <Link to="/MealList">
              <h3>All Meals</h3>
          ...
          <div className="option">
            ...
            {chefs.map((chef) => {
              return (
                <Link to={`/chefs/${chef.chef_name}`} key={chef.id}>
